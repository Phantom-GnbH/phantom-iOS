...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class ChatPrivateView: RCMessagesView, UIGestureRecognizerDelegate {
	...
	init(_ chatId: String, _ recipientId: String) {
		...
		isBlocker = DBRelations.isBlocker(recipientId)
	}
	...
	//.devMARK: - Title details methods
	//-------------------------------------------------------------------------------------------------------------------------------------------
	func updateTitleDetails() {

		if let dbuser = DBUser.fetchOne(gqldb, key: recipientId) {
			labelTitle1.text = dbuser.fullname
			labelTitle2.text = dbuser.lastActiveText()
		}
	}
	...
	//.devMARK: - Typing indicator methods
	//-------------------------------------------------------------------------------------------------------------------------------------------
	...
	//.devMARK: - Message sending methods
	//-------------------------------------------------------------------------------------------------------------------------------------------
...
//.devMARK: - Message Source methods
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView {
...
//.devMARK: - Menu Controller methods
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView {
...
//.devMARK: - Message Input Bar methods
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView {
...
//.devMARK: - UIImagePickerControllerDelegate
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//.devMARK: - AudioDelegate
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView: AudioDelegate {
...
//.devMARK: - StickersDelegate
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView: StickersDelegate {
...
//.devMARK: - SelectUsersDelegate
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension ChatPrivateView: SelectUsersDelegate {
