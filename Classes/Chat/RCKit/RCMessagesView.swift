...
class RCMessagesView: UIViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(RCLocationCell.self, forCellReuseIdentifier: "RCLocationCell")
...
//.devMARK: - InputBarAccessoryViewDelegate
//-----------------------------------------------------------------------------------------------------------------------------------------------
